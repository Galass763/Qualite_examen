...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(PartenaireNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidData(InvalidPartenaireDataException ex) {
